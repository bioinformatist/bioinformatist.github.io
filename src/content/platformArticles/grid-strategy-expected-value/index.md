...
严格说，买入期权本身也不等于纯粹做多波动率。裸买 call 或 put 还带着方向判断；只有通过 delta 对冲等方式把方向暴露剥掉，才更接近在交易 realized volatility / gamma。

真正的 long vol 关注的是凸性和波动率暴露：标的价格大幅运动时，策略有机会从凸性中受益，最大亏损通常由权利金或预设成本限定。

...
![这TM不就在配置路由器一样么摔](/legacy-assets/my-website/img/post_img/同一网段.png)

这个时候，打开浏览器访问192.168.70.125，自动地跳转到了一个类似https://192.168.70.125/designs/imm/index.php 的URL，要求用户信息来登录：

![](/legacy-assets/my-website/img/post_img/服务器内置web-server登录界面.png)
...
![](/legacy-assets/my-website/img/post_img/诊断界面.png)

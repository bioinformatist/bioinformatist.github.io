...
因此建议先[配置镜像](https://help.mirrors.cernet.edu.cn/OpenMediaVault/)。
...
由于同个 pod 间的网络才是互通的（可参考 [Podman pod 文档](https://docs.podman.io/en/latest/markdown/podman-pod.1.html)），所以先确认已经跑起来的`photoprism-app`属于哪个 pod：
